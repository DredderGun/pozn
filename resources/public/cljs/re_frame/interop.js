...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__11162 = cljs.core.instance_QMARK_;
var expr__11163 = reactive_val;
if(cljs.core.truth_(pred__11162.call(null,reagent.ratom.RAtom,expr__11163))){
return "ra";
} else {
if(cljs.core.truth_(pred__11162.call(null,reagent.ratom.RCursor,expr__11163))){
return "rc";
} else {
if(cljs.core.truth_(pred__11162.call(null,reagent.ratom.Reaction,expr__11163))){
return "rx";
} else {
if(cljs.core.truth_(pred__11162.call(null,reagent.ratom.Track,expr__11163))){
return "tr";
} else {
return "other";
}
