...
var vec__12103_12106 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_12107 = cljs.core.nth.call(null,vec__12103_12106,(0),null);
var only_after_12108 = cljs.core.nth.call(null,vec__12103_12106,(1),null);
var db_changed_QMARK__12109 = (!((only_before_12107 == null))) || (!((only_after_12108 == null)));
if(db_changed_QMARK__12109){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_12107);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_12108);
...
var map__12110 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__12110__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__12110__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__12112 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__12112__$1;
var event = cljs.core.get.call(null,map__12112__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__8814__auto___12115 = arguments.length;
var i__8815__auto___12116 = (0);
while(true){
if((i__8815__auto___12116 < len__8814__auto___12115)){
args__8821__auto__.push((arguments[i__8815__auto___12116]));

var G__12117 = (i__8815__auto___12116 + (1));
i__8815__auto___12116 = G__12117;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__8822__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq12114){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12114));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__7645__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__8821__auto__ = [];
var len__8814__auto___12123 = arguments.length;
var i__8815__auto___12124 = (0);
while(true){
if((i__8815__auto___12124 < len__8814__auto___12123)){
args__8821__auto__.push((arguments[i__8815__auto___12124]));

var G__12125 = (i__8815__auto___12124 + (1));
i__8815__auto___12124 = G__12125;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8822__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__12118_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__12119_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__12119_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__7633__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq12120){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__12121,G__12122,seq12120__$2);
});
